...
void main() {
  group('test defi output script', () {
    ...
    test('create swap v2 output', () {
      var defiOutput = DefiTransactionHelper.createPoolSwapV2Output(
          0, 'ttp6uNsrDXTrEguT6AwnCWCjpwxq1SyLKp', 10, 100000000000, 'taMngo4ztuwypWRrptVGRbeNEpnY7ZhPMj', 26, 10224051, [15, 18], defichain_testnet);
      var hexOut = HEX.encode(defiOutput.script!);

      expect(hexOut,
          '6a4c5a446654786917a914f75af6120ea96b811dc6f4d26fcbef203249ec9887000a0000000000000017a9142ceeace439c2a463b8735ee81d5820e60909971287ff00e87648170000001a00000000000000b3019c0000000000020f12');
    });
  });
}
